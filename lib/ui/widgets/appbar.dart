    ...
    title: FutureBuilder<Map<String, dynamic>>(
      ...
      builder: (context, snapshot) {
        ...
        return GestureDetector(
          onTap: () => _showStudentSwitcherBottomSheet(context, students, studentFullName),
          child: Column(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              Row(
                children: [
                  ...
                  const Icon(Icons.arrow_drop_down, color: Colors.black), // Always visible
                ],
              ),
              Text(
                studentClass,
  ...
  try {
    ...
    if (response.statusCode == 200) {
      ...
      if (allStudents.isNotEmpty) {
        ...
        activeStudent = {
          'full_name': '${selected['first_name'] ?? ''} ${selected['last_name'] ?? ''}'.trim(),
...
void _showStudentSwitcherBottomSheet(
    BuildContext context, List<dynamic> students, String currentName) {
            ...
            child: ListView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                return ListTile(
                  ...
                  subtitle: Text(
                    className,
                    style: const TextStyle(fontFamily: AppConstant.fontName),
                  ),
                  trailing: isActive
                  ...
                  onTap: () async {
                    ...
                    SharedPreferences prefs = await SharedPreferences.getInstance();
                    await prefs.setString('active_student_id', student['id'].toString());
                    ...
                    if (context.mounted) {
                      Navigator.pushReplacement(
                        context,
                        MaterialPageRoute(
                          builder: (context) => ScaffoldMessenger.of(context).widget.child ?? const SizedBox(),
                        ),
                      );
                    }
                  },
